    ...
    <section id="nurture" class="bg-white py-16 lg:py-20">
        <div class="mx-auto max-w-7xl px-6">
            ...
            <div class="mt-10 grid grid-cols-1 gap-4 md:grid-cols-12">
                <div class="group relative col-span-1 h-48 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 transition hover:-translate-y-1 hover:shadow-xl md:col-span-6 lg:col-span-3">
