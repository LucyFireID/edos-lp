        ...
        <div class="mx-auto max-w-7xl px-6">
            ...
            <div class="mt-10 grid grid-cols-1 gap-4 md:grid-cols-12">
                ...
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-6">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                    <div class="absolute top-1/2 bottom-0 left-0 z-0 w-full -translate-x-full bg-emerald-500/95 transition-transform duration-500 ease-out group-hover:translate-x-0"></div>
                    <div class="relative z-10 flex h-full flex-col items-start justify-end p-6">
                ...
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-8">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                    <div class="absolute top-1/2 bottom-0 left-0 z-0 w-full -translate-x-full bg-violet-500/95 transition-transform duration-500 ease-out group-hover:translate-x-0"></div>
                    <div class="relative z-10 flex h-full flex-col items-start justify-end p-6">
                ...
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-4">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                    <div class="absolute top-1/2 bottom-0 left-0 z-0 w-full -translate-x-full bg-amber-500/95 transition-transform duration-500 ease-out group-hover:translate-x-0"></div>
                    <div class="relative z-10 flex h-full flex-col items-start justify-end p-6">
