        ...
        <div class="mx-auto max-w-7xl px-6">
            ...
            <div class="mt-10 grid grid-cols-1 gap-4 md:grid-cols-12">
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-6">
                    <img src="{{ asset('images/mi.png') }}" alt="Akademik" class="absolute inset-0 h-full w-full object-cover transition duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent transition duration-500 group-hover:from-black/90"></div>
                ...
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-6">
                    <img src="{{ asset('images/mts.png') }}" alt="Karakter" class="absolute inset-0 h-full w-full object-cover transition duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent transition duration-500 group-hover:from-black/90"></div>
                    <div class="relative flex h-full flex-col items-start justify-end p-6">
                ...
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-8">
                    <img src="{{ asset('images/ma.png') }}" alt="Global" class="absolute inset-0 h-full w-full object-cover transition duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent transition duration-500 group-hover:from-black/90"></div>
                    <div class="relative flex h-full flex-col items-start justify-end p-6">
                ...
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-4">
                    <img src="{{ asset('images/ponpes.png') }}" alt="Kreativitas" class="absolute inset-0 h-full w-full object-cover transition duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent transition duration-500 group-hover:from-black/90"></div>
                    <div class="relative flex h-full flex-col items-start justify-end p-6">
