        ...
        <div class="mx-auto max-w-7xl px-6">
            ...
            <div class="mt-16 grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2 lg:grid-cols-4">
                @foreach ($features as $feature)
                    <div class="group aspect-[10/11] rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100 transition hover:-translate-y-2 hover:shadow-xl {{ $loop->iteration % 2 === 0 ? 'md:mt-[30%]' : '' }}">
