        ...
        <div class="mx-auto max-w-7xl px-6">
            ...
            <div class="mt-10 grid grid-cols-1 gap-4 md:grid-cols-12">
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-6">
                    ...
                    <div class="relative z-10 flex h-full flex-col items-start justify-end p-6">
                        <div class="relative overflow-hidden">
                            <div class="absolute inset-y-0 left-0 z-0 w-full -translate-x-full bg-sky-500/95 transition-transform duration-500 ease-out group-hover:translate-x-0"></div>
                            <span class="relative z-10 rounded-full bg-white/20 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-white backdrop-blur transition-colors duration-500 group-hover:bg-sky-100 group-hover:text-sky-700">Akademik</span>
                            <h3 class="relative z-10 mt-3 text-2xl font-bold text-white transition-colors duration-500 group-hover:text-white">Kurikulum Berkualitas</h3>
                            <p class="relative z-10 mt-2 max-w-md text-sm leading-relaxed text-slate-200 transition-colors duration-500 group-hover:text-slate-100">Pembelajaran berbasis riset dan proyek nyata untuk mengasah kemampuan berpikir kritis.</p>
                        </div>
                    </div>
                </div>
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-6">
                    ...
                    <div class="relative z-10 flex h-full flex-col items-start justify-end p-6">
                        <div class="relative overflow-hidden">
                            <div class="absolute inset-y-0 left-0 z-0 w-full -translate-x-full bg-emerald-500/95 transition-transform duration-500 ease-out group-hover:translate-x-0"></div>
                            <span class="relative z-10 rounded-full bg-white/20 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-white backdrop-blur transition-colors duration-500 group-hover:bg-emerald-100 group-hover:text-emerald-700">Karakter</span>
                            <h3 class="relative z-10 mt-3 text-2xl font-bold text-white transition-colors duration-500 group-hover:text-white">Pembentukan Karakter</h3>
                            <p class="relative z-10 mt-2 max-w-md text-sm leading-relaxed text-slate-200 transition-colors duration-500 group-hover:text-slate-100">Menanamkan nilai-nilai integritas, tanggung jawab, dan kepedulian sosial.</p>
                        </div>
                    </div>
                </div>
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-8">
                    ...
                    <div class="relative z-10 flex h-full flex-col items-start justify-end p-6">
                        <div class="relative overflow-hidden">
                            <div class="absolute inset-y-0 left-0 z-0 w-full -translate-x-full bg-violet-500/95 transition-transform duration-500 ease-out group-hover:translate-x-0"></div>
                            <span class="relative z-10 rounded-full bg-white/20 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-white backdrop-blur transition-colors duration-500 group-hover:bg-violet-100 group-hover:text-violet-700">Global</span>
                            <h3 class="relative z-10 mt-3 text-2xl font-bold text-white transition-colors duration-500 group-hover:text-white">Wawasan Internasional</h3>
                            <p class="relative z-10 mt-2 max-w-md text-sm leading-relaxed text-slate-200 transition-colors duration-500 group-hover:text-slate-100">Program bilingual dan pertukaran pelajar yang memperluas cakrawala dunia.</p>
                        </div>
                    </div>
                </div>
                <div class="group relative col-span-1 h-100 overflow-hidden rounded-2xl bg-slate-100 shadow-sm ring-1 ring-slate-100 md:col-span-4">
                    ...
                    <div class="relative z-10 flex h-full flex-col items-start justify-end p-6">
                        <div class="relative overflow-hidden">
                            <div class="absolute inset-y-0 left-0 z-0 w-full -translate-x-full bg-amber-500/95 transition-transform duration-500 ease-out group-hover:translate-x-0"></div>
                            <span class="relative z-10 rounded-full bg-white/20 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-white backdrop-blur transition-colors duration-500 group-hover:bg-amber-100 group-hover:text-amber-700">Kreativitas</span>
                            <h3 class="relative z-10 mt-3 text-2xl font-bold text-white transition-colors duration-500 group-hover:text-white">Inovasi &amp; Kreativitas</h3>
                            <p class="relative z-10 mt-2 max-w-md text-sm leading-relaxed text-slate-200 transition-colors duration-500 group-hover:text-slate-100">Ruang eksplorasi seni, teknologi, dan entrepreneurship sejak usia dini.</p>
                        </div>
                    </div>
                </div>
            </div>
